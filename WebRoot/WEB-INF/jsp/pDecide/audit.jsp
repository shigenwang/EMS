...
<script type="text/javascript">
	function validate(outCome) {
		...
		if (outCome != "下载审批后的处罚决定书") {
			if (pdfDocument == "" && outCome == "批准") {
				$("#errorInf").html("必须上传签章后的处罚决定书文件");
				return false;
			}
		} else {
...
<SCRIPT type="text/javascript">
	...
	function to_pdf() {
		...
		var openValue = webAip.LoadFile("C:\\juedingshu.aip");
		...
		if (openValue == 1) {
			...
			var paragraph7 = "       "
					+ document.getElementById("paragraph7").innerText + "\n";
			var paragraph8 = "       "
					+ document.getElementById("paragraph8").innerText + "\n";
			...
			webAip
					.SetValue(
							...
							(paragraph1 + paragraph2 + paragraph3 + paragraph4
									+ paragraph5 + paragraph7 + paragraph8));
	...
	<div class="container">
		<div class="col-md-10 col-md-offset-1">
			<article class="article">
				<h4>
					郑州市中原区城市管理行政执法局<br>行&nbsp;政&nbsp;处&nbsp;罚&nbsp;决&nbsp;定&nbsp;书
				</h4>
				<footer class="text-center"
					style="color: #767676; font-family: 12px;">
					(中原行执)罚决字【<span id="yearNum"><fmt:formatDate
							value="${accreditation.bigCaptainDate }" pattern="yyyy" /></span>】第<span
						id="caseId">&nbsp;${accreditation.id }&nbsp;</span>号
				</footer>
				<hr>
				<span id="paragraph1" > <pre
						style="border: none; background: none; font-size: 1.2em; font-family: 'Microsoft YaHei'">${accreditation.pNotice.paragraph1 }</pre></span>
				...
				<p>
					<span id="paragraph7"  style="line-height:1.8em">${paragraph7 }</span>
				</p>
				<p>
					<span id="paragraph8"  style="line-height:1.8em">${paragraph8 }</span>
				</p>
				<div class="col-md-5 col-md-offset-6" style="margin-bottom: 0px;">
					<br>
					<br>
					<p>郑州市中原区城市管理行政执法局</p>
					<p class="text-center">
			...
			<form class="form-horizontal col-md-12 col-md-offset-0"
				action="pDecideAction_submitTask"
				...
				<s:if test="#outcomeList!=null && #outcomeList.size()==2">
					<div style="margin-left: 30">
						<div class="form-group">
							...
							<p class="help-block">签章成功后，必须上传签章后的处罚决定书，以便由中队打印</p>
						</div>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<textarea class="form-control" rows="5" style="margin-top: 0"
								name="legalSuggest" id="legalSuggest"></textarea>
				...
				<input name="taskId" type="hidden" value="${taskId }"> <input
					name="pDecideId" type="hidden" value="${id }">
