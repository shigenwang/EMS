...
<script type="text/javascript" src="js/jquery-1.4.2.min.js"></script> 
  ...
  <div class="container">
  	...
  	<div class="col-md-10 col-md-offset-0">
        ...
        <caption>郑州市中原区城市管理行政执法局<br>业务会办公案件审批表</caption>  
          <tr>
            <th width="20%">案由</th>
          ...
          <tr>
            <th width="20%">业委会成员签名</th>
           
            	<td colspan="3" height="100">${indCommNames }
	...
	<div class="row" style="margin-top:40px;">  
        				<core:if test="${!empty CRCSuggest }">
        				 <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10  col-md-offset-0" >
	          				<p class="bg-primary">上次业委会驳回时意见</p>
         			 ...
         			 <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10  col-md-offset-0" >
          				...
          				<textarea class="form-control" rows="5"  style="margin-top: 0" name="ICASuggest" id="suggest" ></textarea>
