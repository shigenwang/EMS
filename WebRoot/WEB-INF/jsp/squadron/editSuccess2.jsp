  ...
  <DIV ID="MainArea">
        ...
        <DIV CLASS="ItemBlockBorder" STYLE="margin-left: 15px;margin-top: 150px;">
            <DIV CLASS="ItemBlock" STYLE="text-align: center; font-size: 16px;">
                <img  src="${pageContext.request.contextPath}/images/face.png">恭喜您!      中队信息修改成功。
            </DIV>
        </DIV>
        
        <!-- 操作 -->
        <DIV ID="InputDetailBar" STYLE="text-align: right;margin-right: 270px;margin-top: 60px;">
            <a href="squadronAction_squadronEditUI?id=${squadornSign.id}"   style="color:black"><IMG SRC="${pageContext.request.contextPath}/images/goBack.png"/></A>
        </DIV>
