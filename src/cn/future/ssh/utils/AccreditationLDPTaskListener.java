 ...
 * 流程中的任务节点执行完毕后执行此类
 * */
public class AccreditationLDPTaskListener implements TaskListener {
	...
	public void notify(DelegateTask delegateTask) {
		...
		variables.put("legalDepartmentPersonnelsIds", "-1,-1");
		variables.put("legalDepartmentPersonnelId", Long.toString(SessionContext.get().getId()));
