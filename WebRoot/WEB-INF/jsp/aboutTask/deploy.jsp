...
<body>
			     ...
			     <s:iterator value="#depList">
			        <tr>
				        ...
				        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
				        	<a href="aboutTaskAction_delDeployment.action?deploymentId=<s:property value="id"/>">删除</a>
				        </div></td>
				    </tr> 
		        </s:iterator>
		      </s:if>
			     ...
			     <s:if test="#pdList!=null&&#pdList.size()>0">
			     	<s:iterator value="#pdList">
				        <tr>
					        ...
					        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
					        	<a target="_blank" href="workflowAction_viewImage.action?deploymentId=<s:property value="deploymentId"/>&imageName=<s:property value="diagramResourceName"/>">查看流程图</a></div> 
						 </td>
					    </tr> 
		      		 </s:iterator>
		       </s:if>
	...
	<br/>
	<!-- 发布流程 -->
	<form action="aboutTaskAction_newdeploy.action" enctype="multipart/form-data" method="POST">
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
		    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		      <tr>
