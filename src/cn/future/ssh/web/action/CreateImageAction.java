...
/*
 * 生成随机验证码图片的action，将生成的随机数放到session里，然后页面提交到验证随机数的action
 */
public class CreateImageAction extends ActionSupport
{
    ...
    {
    	String str = "123456789123456789123456789ABCDEFGHJKLMNPQRS"
    			+ "TUVWXYZ123456789123456789123456789abcdefghjkmnpqrstuvwxyz";
    ...
    private void drawRands(Graphics g, String rands)
    {
        ...
        g.drawString("" + rands.charAt(0), 2, 17);
